...
<head>
    ...
    <title>{{ config('Digitalni tanjur', 'Digitalni tanjur') }}</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm transparent-navbar">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('Digitalni tanjur', 'Digitalni tanjur') }}
                </a>
